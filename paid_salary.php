                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h1 class="pageheader-title">Paid Salary
                                </h1>
                            </div>
                            <div class="container">
                                <table id="myTable">
                                    ...
                                    <tbody>
                                        <?php
                                        $sl = 1;
                                        $attendance_info = mysqli_query($conn, "SELECT users.*,attendence.*,users.id as user_id, attendence.id as attendanceId FROM users INNER JOIN attendence ON attendence.employee_id = users.id where attendence.is_paid = 1 ORDER BY attendence.id DESC");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="d-flex"><form action="" method="POST">
                                                ...
                                                <a href="payslip.php?id=<?= $fetch['attendanceId'] ?>" class="btn btn-xs btn-outline-info">Download Payslip</a>
                                                </td>
                                            </tr>
                                        <?php $sl++;
                                        } ?>
