                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Project <span><a href="create_project.php" class="btn btn-xs btn-outline-success">Add New</a></span> </h2>
                            </div>
                            <div class="page-body">
                                <table id="myTable">
                                    <thead>
                                    ...
                                    <tbody>
                                        <?php
                                        $project = mysqli_query($conn, "SELECT project.*,users.first_name,users.last_name  FROM `project` INNER JOIN users on users.id = project.employee_id ");
                                        $sl = 1;
